    ...
    return (
        <Container className='py-6 lg:py-10'>
            <div className='flex flex-col lg:flex-row justify-center lg:justify-between gap-4 lg:gap-10 items-center'>
                <Typography variant='body' size='md' className='text-center md:text-start order-2 lg:order-1 max-w-xs md:max-w-full max-md:mx-auto'>© Copyright 2024 vellody communications. All rights reserved.</Typography>
